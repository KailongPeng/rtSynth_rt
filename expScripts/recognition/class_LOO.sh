...
echo python -u /gpfs/milgram/project/turk-browne/projects/rtSynth_rt/expScripts/recognition/class_LOO.py $1 $SLURM_ARRAY_TASK_ID
python -u /gpfs/milgram/project/turk-browne/projects/rtSynth_rt/expScripts/recognition/class_LOO.py $1 $SLURM_ARRAY_TASK_ID
